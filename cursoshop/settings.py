"""
Django settings for cursoshop project.
...
SECRET_KEY = '%_d6uyvyrwl)x$(ih2=rtm=3-p7=fl1lz$e^=_h%kvq!sqh98i'
...
WSGI_APPLICATION = 'cursoshop.wsgi.application'
